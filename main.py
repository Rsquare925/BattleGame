...
# Instantiate People
player1 = Person("Goku  :", 3260, 132, 300, 34, player_spells, player_items)
player2 = Person("Vegeta:", 4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Gohan :", 3089, 174, 288, 34, player_spells, player_items)

enemy1 = Person("Vilgax ", 1250, 130, 560, 325, enemy_spells, [])
enemy2 = Person("Agrigor", 18200, 701, 525, 25, enemy_spells, [])
enemy3 = Person("khaibr ", 1250, 130, 560, 325, enemy_spells, [])
...
while running:
    ...
    # check if enemy won
        ...
        print(bcolors.FAIL + "You enemies have defeated you!!" + bcolors.ENDC)
        running = False
